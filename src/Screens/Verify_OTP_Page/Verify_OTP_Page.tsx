...
const VerifyOTPPage: FunctionComponent = observer(() => {
    ...
    const [pinText, setPinText] = useState<string>(
        "A PIN has been sent to your Account. Please check your Email for the PIN or click the 'Resend PIN' to generate a new PIN. In case you can't find the code in your inbox, kindly check your spam folder.",
    );
    ...
    const sign_out = async () => {
        ...
        try {
            ...
            await SInfo.deleteItem(SECURE_STORAGE_ADMIN_DATA, {
                sharedPreferencesName: SECURE_STORAGE_NAME,
                keychainService: SECURE_STORAGE_NAME,
            });
