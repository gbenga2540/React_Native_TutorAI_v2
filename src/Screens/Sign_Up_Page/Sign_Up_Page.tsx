...
const SignUpPage: FunctionComponent = observer(() => {
    ...
    const nav_to_tc_page = no_double_clicks({
        execFunc: () => {
            navigation.navigate('AuthStack', { screen: 'TCPage' });
        },
    });
            ...
            <ScrollView style={{ flex: 1 }}>
                ...
                {question === 3 && (
                    <Fragment>
                        ...
                        />
                        <BasicText
                            inputText="We've just sent your OTP code to verify your Email Address. Please check your email. In case you can't find the code in your inbox, kindly check your spam folder."
                            width={330}
                            textSize={15}
                            marginBottom={12}
                            textAlign="center"
